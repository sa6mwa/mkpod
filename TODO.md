...
- [x] Revisit AWS SDK choice:
  - [x] migrate the S3 layer from AWS SDK for Go v1 to v2
  - [x] keep the migration scoped to the concrete storage package instead of mixing it with broader refactors
